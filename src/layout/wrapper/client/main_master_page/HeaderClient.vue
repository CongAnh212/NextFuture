                            ...
                            <a
                                ...
                                <div
                                    ...
                                    style="
                                        ...
                                        width: 20px;
                                        height: 20px;
                                        background-color: rgb(249, 64, 95);
                                    ">
                            ...
                            <div
                                ...
                                <div class="card shadow-none m-0">
                                    ...
                                    <div
                                        ...
                                        style="max-height: 65vh; overflow: auto">
                                        <a
                                            v-for="(v, k) in list_notifications"
                                            class="iq-sub-card bg-hover"
                                            @click="readNotification(v)">
                                            <router-link
                                                v-if="v.type == 2"
                                                :to="{
                                                    name: 'home-group',
                                                    params: { id_group: v.id_group },
                                                    query: { id_notification: v.id },
                                                }">
                                                <div class="d-flex align-items-center">
                                                    <div v-if="v.status == 1">
                                                        <img
...
export default {
    ...
    methods: {
        ...
        getNotification() {
            axios.get("notification/data").then((res) => {
